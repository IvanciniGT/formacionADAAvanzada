...
package body Partida is
    ...
    function JUGAR_PARTIDA(juego: JUGABLE ; numero_manos_maximas: Integer; numero_manos_para_ganar: Integer) return RESULTADO is
        ...
        resultados_acumulados_manos: array(RESULTADO) of Integer := (0, 0, 0); 
        ...
        ganador: RESULTADO;
    begin
        while HAY_QUE_SEGUIR_JUGANDO(resultado_acumulados_manos, numero_manos_maximas, numero_manos_para_ganar) loop
        ...
        ganador:= DETERMINAR_GANADOR(resultados_acumulados_manos);
    ...
    function HAY_QUE_SEGUIR_JUGANDO(resultados_acumulados_manos: array(RESULTADO) of Integer;
                                    numero_manos_maximas: Integer; 
                                    numero_manos_para_ganar: Integer
    ) return Boolean is
        manos_jugadas: Integer := resultados_acumulados_manos(COMPUTADORA) + resultados_acumulados_manos(JUGADOR) + resultado_acumulados_manos(EMPATE);
    begin
    ...
    function DETERMINAR_GANADOR(resultados_acumulados_manos: array(RESULTADO) of Integer ) is
    begin
